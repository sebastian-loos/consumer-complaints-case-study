...
As one can see, the good (but not perfect!) fit of the final model is also visible in this visualization of the distribution of the different complaint/product categories for the test split of the whole training dataset.
